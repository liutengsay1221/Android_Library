...
public class ToolBarHelper {
    ...
    * */
    ...
    public ToolBarHelper(Context context, int layoutId, boolean isFitsSystemWindows) {
        this(context, layoutId, true, context.getResources().getColor(R.color.primary), isFitsSystemWindows);
    }

    public ToolBarHelper(Context context, int layoutId, boolean isToolBarVisible, int toolBarColor, boolean isFitsSystemWindows) {
...
//        int toolBarSize = (int) typedArray.getDimension(1, APKUtil.dip2px(mContext,30));
        int toolBarSize = APKUtil.dip2px(mContext, 45);
        typedArray.recycle();
