...
public final class GsonConverterFactoryPlus extends Converter.Factory {
     ...
     */
    public static GsonConverterFactoryPlus create() {
     ...
     * decoding from JSON (when no charset is specified by a header) will use UTF-8.
     */
    public static GsonConverterFactoryPlus create(Gson gson) {
        return new GsonConverterFactoryPlus(gson);
    }

    private final Gson gson;

    private GsonConverterFactoryPlus(Gson gson) {
